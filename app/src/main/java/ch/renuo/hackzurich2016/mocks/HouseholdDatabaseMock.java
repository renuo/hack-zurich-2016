...
public class HouseholdDatabaseMock {
    ...
    public HouseholdDatabaseMock(String householdId){
        ...
        ClusterAlarm c1a1 = new ClusterAlarmImpl(UUID.randomUUID(), "12:33", false);
        cluster1.getClusterAlarms().add(c1a1);
        ClusterAlarm c1a2 = new ClusterAlarmImpl(UUID.randomUUID(), "14:55", true);
        cluster1.getClusterAlarms().add(c1a2);
        for(int i=0;i<10;i++) {
            cluster1.getClusterAlarms().add(new ClusterAlarmImpl(UUID.randomUUID(), "12:32", false));
        }
        ...
        ClusterAlarm c2a1 = new ClusterAlarmImpl(UUID.randomUUID(), "08:00", true);
